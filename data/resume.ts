...
export const resumeData: ResumeData = {
  "experience": [
    {
      ...
      "roles": [
        ...
        },
        {
          ...
          "skills": ["AngularJS", "HTML", "Zod", "Python", "STIX"]
        },
        {
          "heading": "Intern Coordinator",
          "icon": "🤝",
          "bullets": [
            "Department intern coordinator, overseeing hiring, mentorship, and performance evaluations"
          ],
  ...
  "education": [
    {
      ...
      "thesis": {
        "title": "A User-Centered Design Approach to Evaluating the Usability of Automated Essay Scoring Systems",
  ...
  "skills": [
    "React", "JavaScript", "TypeScript", "AngularJS", "HTML", "CSS", "Vue", "Python", "Django", "REST APIs", "MySQL", "Java", "C", "Docker", "GitLab CI/CD", "Git", "Vite", "Jest", "React Testing Library", "High-Performance Computing", "Survey Analysis", "Usability Testing", "User Research", "AI Usability", "Figma", "Leadership", "Mentorship"
  ],
  "aboutPageSkills": [
    "Web Development",
    "UI/UX Design",
  ...
  "publications": [
    ...
    },
    {
      ...
      "conference": "International Conference on Artificial Intelligence in Education (AIED) 2023",
      "date": "June 2023",
  ...
  "clearances": ["DoD Secret", "IRS Moderate (MBI)"],
  "memberships": [
    {
