...
const Navbar: React.FC = () => {
  ...
  const getLinkClasses = (isActive: boolean) =>
    `text-sm font-medium transition-colors duration-200 tracking-wide ${isActive
  ...
  return (
    <nav
      className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-white/95 backdrop-blur-sm shadow-sm' : 'bg-transparent'
        }`}
    >
